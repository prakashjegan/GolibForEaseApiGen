...
func TestGetConfig(t *testing.T) {
	...
	expected.Database.MongoDB.Env.AppName = "golangexercise"
	...
	expected.EmailConf.HTMLModel = "product_url:https://github.com/prakashjegan/golangexercise;product_name:golangexercise;company_name:pilinux;company_address:Country"
	...
	expected.Logger.SentryDsn = "https://baf43587767b44758ec9c6fe24b0c6be@o4504800847659008.ingest.sentry.io/4504800853491712"
	...
	expected.Security.JWT.AccessKeyTTL = 500
	expected.Security.JWT.RefreshKey = []byte("cryptographic_key_2")
	expected.Security.JWT.RefreshKeyTTL = 6000

	expected.Security.JWT.Audience = "audience"
	expected.Security.JWT.Issuer = "golangexercise"
	...
	expected.Security.TwoFA.Issuer = "golangexercise"
